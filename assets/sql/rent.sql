...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2015 at 05:38 PM
...
INSERT INTO `city` (`CityId`, `CityIndex`, `CityTitle`) VALUES
(3, 1, 'Апрелевка'),
(4, 2, 'Балашиха'),
(5, 3, 'Видное'),
(6, 4, 'Волоколамск'),
...
(6, 'ТОРГОВОЕ', 'ПРОДАЖА', 'МОСКВА', 1, 0, 222, 6, 70000),
(7, 'БИЗНЕС', 'ПРОДАЖА', 'ЗЕЛЕНОГРАД', 2, 0, 288, 5, 103000),
(8, 'БИЗНЕС', 'ПРОДАЖА', 'МОСКВА', 1, 0, 737, 2, 283000),
(9, 'СКЛАД', 'ПРОДАЖА', 'МОСКВА', 1, 0, 1270, 3, 50000),
(10, 'СКЛАД', 'ПРОДАЖА', 'МОСКВА', 1, 0, 3260, 1, 69000),
